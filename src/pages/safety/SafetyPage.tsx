...
const travelAdvisories: TravelAdvisory[] = [
  {
    ...
    level: 'moderate',
    description: 'Heavy rainfall may cause landslides and flash floods in certain areas. Road conditions may deteriorate, and some trekking routes might be closed.',
    date: 'June 15, 2023',
    areas: ['Netarhat Hills', 'Parasnath Hills', 'Waterfall circuits'],
  },
  {
    id: 2,
    title: 'Wildlife Movement Advisory',
    level: 'moderate',
    description: 'Increased wildlife movement reported in buffer zones around Betla National Park and Palamau Tiger Reserve. Visitors are advised to stay on designated paths and avoid dawn/dusk travel in these areas.',
    date: 'May 20, 2023',
    areas: ['Betla National Park', 'Palamau Tiger Reserve', 'Surrounding forest areas'],
  },
  {
    id: 3,
    title: 'Remote Areas Connectivity',
    level: 'low',
    description: 'Some remote tribal areas have limited mobile connectivity. Travelers planning to visit isolated regions should inform their accommodation about their itinerary and expected return time.',
    date: 'April 10, 2023',
    areas: ['Remote tribal villages', 'Deep forest areas', 'Certain parts of Saranda Forest'],
  },
];
